...
public class LibraryController {
	...
	public List<BooksDTO> listPatronCheckouts(@PathVariable int patron_id) throws ResponseStatusException {
	...
	public PatronsDTO fetchPatron(@PathVariable int patron_id) throws ResponseStatusException  {
